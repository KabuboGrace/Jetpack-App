...
fun mytext(){
    Column(modifier = Modifier.fillMaxSize()) {
      ...
      Row(modifier = Modifier.fillMaxSize().background(color = Color.LightGray)) {
        Text(text = "Yes", fontSize = 30.sp, fontStyle = FontStyle.Normal)
        Text(text = "No", fontSize = 30.sp, fontStyle = FontStyle.Italic)
    }
